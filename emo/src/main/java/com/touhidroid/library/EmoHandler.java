...
//        Emoji.fromChars("\u0023\u20e3"),
    ...
    public static void addEmojis(Context context, Spannable text, int emojiSize, int index, int length) {
        ...
        EmoSpan[] oldSpans = text.getSpans(0, textLength, EmoSpan.class);
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon > 0) {
                text.setSpan(new EmoSpan(context, icon, emojiSize), i, i + skip, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    }
}
